...
public class ResumeTestData {
    public static void main(String[] args) throws ParseException {
        ...
        resume.addSection(SectionType.OBJECTIVE, new StringsData("Позиция\n" +
                "Ведущий стажировок и корпоративного обучения по Java Web и Enterprise технологиям"));
        resume.addSection(SectionType.PERSONAL, new StringsData("Личные качества\n" +
        ...
        experience.add(new Organization("Java Online Projects\n", "Автор проекта", "10/2013",
                "сейчас", "Создание, организация и проведение Java онлайн проектов и стажировок."));
        experience.add(new Organization("Wrike\n", "Старший разработчик (backend)", "10/2014",
                "01/2016", "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring,\n" +
                " MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1,\n" +
                " OAuth2, JWT SSO."));
        experience.add(new Organization("RIT Center\n", "Java архитектор", "04/2012",
                "10/2014", "Организация процесса разработки системы ERP для разных окружений: релизная политика, версионирование,\n" +
        ...
        experience.add(new Organization("Luxoft (Deutsche Bank)\n", "Ведущий программист", "12/2010",
                "04/2012", "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, Spring, Spring MVC, SmartGWT, GWT, Jasper,\n" +
        ...
        experience.add(new Organization("Yota\n", "Ведущий специалист", "06/2008",
                "12/2010", "Дизайн и имплементация Java EE фреймворка для отдела \"Платежные Системы\" (GlassFish v2.1, v3, OC4J,\n" +
        ...
        experience.add(new Organization("Enkata\n", "Разработчик ПО", "03/2007",
                "06/2008", "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного\n" +
                " J2EE приложения (OLAP, Data mining)."));
        experience.add(new Organization("Siemens AG\n", "Разработчик ПО", "01/2005",
                "02/2007", "Разработка информационной модели, проектирование интерфейсов, реализация и отладка ПО на мобильной\n" +
                " IN платформе Siemens @vantage (Java, Unix)."));
        experience.add(new Organization("Alcatel\n", "Инженер по аппаратному и программному тестированию", "09/1997",
                "01/2005", "Тестирование, отладка, внедрение ПО цифровой телефонной станции Alcatel 1000 S12 (CHILL, ASM)."));
        ...
        education.add(new Organization("Coursera\n", "", "03/2013",
                "05/2013", "\"Functional Programming Principles in Scala\" by Martin Odersky"));
        education.add(new Organization("Luxoft\n", "", "03/2011",
                "04/2011", "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\""));
        education.add(new Organization("Siemens AG\n", "", "01/2005",
                "04/2005", "3 месяца обучения мобильным IN сетям (Берлин)"));
        education.add(new Organization("Alcatel\n", "", "09/1997",
                "03/1998", "6 месяцев обучения цифровым телефонным сетям (Москва)"));
